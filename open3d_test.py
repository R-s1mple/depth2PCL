...
if __name__ == "__main__":
    camera_poses = read_trajectory("examples\\test_data\\RGBD\\odometry.log")
    ...
    for i in range(len(camera_poses)):
        ...
        color = o3d.io.read_image(
            "examples\\test_data\\RGBD\\color\\{:05d}.jpg".format(i))
        depth = o3d.io.read_image(
            "examples\\test_data\\RGBD\\depth\\{:05d}.png".format(i))
